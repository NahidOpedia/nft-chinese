        ...
        <Grid container>
            <Grid item  lg={8}  >
                  ...
                  <h1 className= "mt-4">{detail?.title}</h1>
                     <img src={detail?.cover} className='coverImg' style={{width: '40%',
    borderRadius: '10%',
    display:' inline-block',
    marginTop: '40px'}} alt="" />
        <p style={{fontSize:'18px'}} className="mt-4">{detail.created}</p>

            <div style={{fontSize:'18px',color:'#777'}} className="text-center"
